  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-white text-foreground shadow-xs hover:bg-slate-50 hover:border-slate-300 hover:text-foreground",
        secondary:
          "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/90",
        ghost: "hover:bg-slate-100 hover:text-foreground",
        gradient: "ai-gradient-bg text-white shadow-sm hover:shadow-md hover:shadow-primary/25 hover:opacity-95",
