...
from app.engines.classifier import DOCUMENT_TAXONOMY, get_extraction_prompt, get_category, get_label
...
class GeminiVLM:
    ...
    def __init__(self, model_name: str = None, api_key: str = None):
        try:
            ...
            raise ImportError("google-generativeai is required for Gemini VLM. Install it using pip.")
    ...
    def _image_to_pil(self, image) -> Image.Image:
        ...
        elif HAS_CV2_NUMPY and isinstance(image, np.ndarray):
