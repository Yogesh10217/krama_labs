...
class DocumentConverter:
    ...
    def pptx_to_images(cls, path: str) -> List[Image.Image]:
        ...
        try:
            ...
            raise ImportError("matplotlib is required for PPTX fallback rendering. Install it using pip.")

        try:
            from pptx import Presentation
        except ImportError:
            raise ImportError("python-pptx is required for PPTX conversion. Install it using pip.")
    ...
    def excel_to_images(cls, path: str) -> List[Image.Image]:
        try:
            ...
            raise ImportError("matplotlib is required for Excel table rendering. Install it using pip.")

        try:
            import openpyxl
        except ImportError:
            raise ImportError("openpyxl is required for Excel reading. Install it using pip.")
